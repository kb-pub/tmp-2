...
//        zip();
    ...
    static void serialization() throws Exception {
        var data = new Data(10, 20);

        var file = Path.of("/home/kb/serial.dat");

        try (var o = new ObjectOutputStream(Files.newOutputStream(file, CREATE, WRITE))) {
            o.writeObject(data);
        }
    ...
    record Data(int x, int y) implements Serializable {
    }
